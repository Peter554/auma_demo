(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    define("auma", [], factory);
  else if (typeof exports === "object") exports["auma"] = factory();
  else root["auma"] = factory();
})(this, function () {
      ...
      */
                if (_config2.default.audio.duration >= seconds && seconds > 0) {
                  ...
                  _debug2.default.writeMessage(
                    "auma can't skip to a location greater than the duration of the audio or less than 0"
                  );
                }
              },
              { once: true }
  ...
  */
    ...
    */
            var playPauseElements =
              document.querySelectorAll(".auma-play-pause");
    ...
    */
      ...
      */
              var playlist =
                playPauseElements[i].getAttribute("data-auma-playlist");
              var song = playPauseElements[i].getAttribute(
                "data-auma-song-index"
              );
    ...
    */
            var playlistPlayPauseElements = document.querySelectorAll(
              '.auma-play-pause[data-auma-playlist="' +
    ...
    */
            var songPlayPauseElements = document.querySelectorAll(
              '.auma-play-pause[data-auma-song-index="' +
    ...
    */
      ...
      */
              var playlist =
                songPlayPauseElements[i].getAttribute("data-auma-playlist");
  ...
  */
    ...
    */
      ...
      */
              var playlist =
                songInfoElements[i].getAttribute("data-auma-playlist");
    ...
    */
      ...
      */
              ...
              var playlist =
                playlistInfoElements[i].getAttribute("data-auma-playlist");
    ...
    */
            var songInfoElements = document.querySelectorAll(
              '[data-auma-song-info][data-auma-playlist="' + playlist + '"]'
            );
    ...
    */
      ...
      */
              if (
                repeatButtons[i].getAttribute("data-auma-playlist") == playlist
              ) {
                /*
    ...
    */
            var repeatSongClasses =
              document.getElementsByClassName("auma-repeat-song");
    ...
    */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VolumeSliderElements = (function () {
          ...
          function sync() {
            var volumeSliders =
              document.getElementsByClassName("auma-volume-slider");
  ...
  */
    ...
    */
            var mainSongSliders =
              document.querySelectorAll(".auma-song-slider");
    ...
    */
      ...
      */
              var playlist =
                mainSongSliders[i].getAttribute("data-auma-playlist");
    ...
    */
            var playlistSongSliders = document.querySelectorAll(
              '.auma-song-slider[data-auma-playlist="' + playlist + '"]'
            );
    ...
    */
        ...
        Grab the playlist and song attributes from the element.
      */
              var playlistAttribute =
                playlistSongSliders[i].getAttribute("data-auma-playlist");
    ...
    */
      ...
      */
              var songSliders = document.querySelectorAll(
                '.auma-song-slider[data-auma-song-index="' + songIndex + '"]'
              );
      ...
      */
        ...
        */
                var playlistAttribute =
                  songSliders[i].getAttribute("data-auma-playlist");
    ...
    */
            var songInPlaylistSliders = document.querySelectorAll(
              '.auma-song-slider[data-auma-playlist="' +
                playlist +
                '"][data-auma-song-index="' +
                activePlaylistIndex +
                '"]'
    ...
    */
          ...
          function resetElements() {
            var songSliders =
              document.getElementsByClassName("auma-song-slider");
    ...
    */
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _currentTimeElements2 =
          _interopRequireDefault(_currentTimeElements);

        var _currentHourElements = __webpack_require__(50);

        var _currentHourElements2 =
          _interopRequireDefault(_currentHourElements);
    ...
    */
      ...
      */
          ...
          */
            ...
            */
                  var playlist =
                    visualizationElements[i].getAttribute("data-auma-playlist");
    ...
    */
        ...
        */
                var playlist =
                  visualizationElements[x].getAttribute("data-auma-playlist");
    ...
    */
      ...
      */
          ...
          */
                  ...
                  if (addToShuffleList) {
                    _config2.default.shuffle_list[index].soundcloud_data =
                      sound;
                  }
                }
              } else {
                if (playlist != null) {
                  aumaHelpers.writeDebugMessage(
  ...
  */
    ...
    */
      ...
      */
              playbackSpeedClasses[i].classList.remove(
                "auma-playback-speed-10"
              );
              playbackSpeedClasses[i].classList.remove(
                "auma-playback-speed-15"
              );
              playbackSpeedClasses[i].classList.remove(
                "auma-playback-speed-20"
              );
    ...
    */
            var shuffleButtons =
              document.getElementsByClassName("auma-shuffle");
    ...
    */
      ...
      */
              if (
                shuffleButtons[i].getAttribute("data-auma-playlist") == null
              ) {
                /*
    ...
    */
            var shuffleButtons = document.querySelectorAll(
              '.auma-shuffle[data-auma-playlist="' + playlist + '"]'
            );
    ...
    */
      ...
      */
              var songPlayedProgressBars = document.querySelectorAll(
                ".auma-song-played-progress"
              );

              for (var i = 0; i < songPlayedProgressBars.length; i++) {
                var playlist =
                  songPlayedProgressBars[i].getAttribute("data-auma-playlist");
    ...
    */
      ...
      */
              var songPlayedProgressBars = document.querySelectorAll(
                '.auma-song-played-progress[data-auma-playlist="' +
                  _config2.default.active_playlist +
                  '"]'
              );
      ...
      */
        ...
        */
                var songPlayedProgressBars = document.querySelectorAll(
                  '.auma-song-played-progress[data-auma-song-index="' +
                    _config2.default.active_index +
                    '"]'
                );
                ...
                for (var i = 0; i < songPlayedProgressBars.length; i++) {
                  var playlist =
                    songPlayedProgressBars[i].getAttribute(
                      "data-auma-playlist"
                    );
    ...
    */
      ...
      */
        ...
        */
              ...
              _debug2.default.writeMessage(
                "Please provide a songs object for aumaJS to run!"
              );
            }
  ...
  */
    ...
    */
      ...
      */
              var playlist =
                waveformElements[i].getAttribute("data-auma-playlist");
  ...
  */
    ...
    */
            for (var i = 0; i < songBufferedProgressBars.length; i++) {
              var playlist =
                songBufferedProgressBars[i].getAttribute("data-auma-playlist");
              ...
              if (
                playlist == null &&
                song == null &&
                !isNaN(_config2.default.buffered)
              ) {
    ...
    */
            var songBufferedProgressBarsPlaylist = document.querySelectorAll(
              '.auma-buffered-progress[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
    ...
    */
            var songBufferedProgressBarsSongs = document.querySelectorAll(
              '.auma-buffered-progress[data-auma-song-index="' +
                _config2.default.active_index +
                '"]'
            );
    ...
    */
            for (var i = 0; i < songBufferedProgressBarsSongs.length; i++) {
              var playlist =
                songBufferedProgressBarsSongs[i].getAttribute(
                  "data-auma-playlist"
                );
    ...
    Gets all of the song buffered progress bars.
    */
            var songBufferedProgressBarsSongsInPlaylist =
  ...
  */
    ...
    */
            var play_pause_classes =
              document.getElementsByClassName("auma-play-pause");
    ...
    */
            var volume_up_classes =
              document.getElementsByClassName("auma-volume-up");
    ...
    */
            var volume_down_classes =
              document.getElementsByClassName("auma-volume-down");
...
*/
  ...
  */
    ...
    */
      ...
      */
              if (location == null) {
                _debug2.default.writeMessage(
                  "You must add an 'data-auma-location' attribute in seconds to your 'auma-skip-to' element."
                );
              }
      ...
      */
              if (songIndex == null) {
                _debug2.default.writeMessage(
                  "You must add an 'data-auma-song-index' attribute to your 'auma-skip-to' element."
                );
              }
  ...
  */
    ...
    */
      ...
      */
              var songCompletionPercentage =
                _time2.default.computeSongCompletionPercentage();
    ...
    */
      ...
      */
              _config2.default.analyser =
                _config2.default.context.createAnalyser();
      ...
      */
              _config2.default.source =
                _config2.default.context.createMediaElementSource(
          ...
          function setPlaylistVisualization(playlist, visualizationKey) {
            if (_config2.default.playlists[playlist] != undefined) {
              if (
                ...
                _config2.default.playlists[playlist].visualization =
                  visualizationKey;
              } else {
                _debug2.default.writeMessage(
          ...
          function setSongVisualization(songIndex, visualizationKey) {
            if (_config2.default.songs[songIndex]) {
              if (
                ...
                _config2.default.songs[songIndex].visualization =
                  visualizationKey;
              } else {
                _debug2.default.writeMessage(
                  "A visualization does not exist for the key provided."
  ...
  */
    ...
    */
      ...
      */
              ...
              if (
                document.querySelectorAll(
                  '.auma-song-container[data-auma-song-index="' +
                    activeIndex +
                    '"]'
                )
              ) {
    ...
    */
            for (var i = 0; i < currentHourSelectors.length; i++) {
              var playlist =
                currentHourSelectors[i].getAttribute("data-auma-playlist");
    ...
    */
            var currentHourPlaylistSelectors = document.querySelectorAll(
              '.auma-current-hours[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
    ...
    */
      ...
      */
              var currentHourSongSelectors = document.querySelectorAll(
                '.auma-current-hours[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
      ...
      */
              for (var i = 0; i < currentHourSongSelectors.length; i++) {
                var playlist =
                  currentHourSongSelectors[i].getAttribute(
                    "data-auma-playlist"
                  );
    ...
    */
            for (var i = 0; i < currentMinuteSelectors.length; i++) {
              var playlist =
                currentMinuteSelectors[i].getAttribute("data-auma-playlist");
    ...
    */
            var currentMinutePlaylistSelectors = document.querySelectorAll(
              '.auma-current-minutes[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
    ...
    */
      ...
      */
              var currentMinuteSongSelectors = document.querySelectorAll(
                '.auma-current-minutes[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
      ...
      */
              for (var i = 0; i < currentMinuteSongSelectors.length; i++) {
                var playlist =
                  currentMinuteSongSelectors[i].getAttribute(
                    "data-auma-playlist"
                  );
    ...
    */
            for (var i = 0; i < currentSecondSelectors.length; i++) {
              var playlist =
                currentSecondSelectors[i].getAttribute("data-auma-playlist");
    ...
    */
            var currentSecondPlaylistSelectors = document.querySelectorAll(
              '.auma-current-seconds[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
    ...
    */
      ...
      */
              var currentSecondSongSelectors = document.querySelectorAll(
                '.auma-current-seconds[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
      ...
      */
              for (var i = 0; i < currentSecondSongSelectors.length; i++) {
                var playlist =
                  currentSecondSongSelectors[i].getAttribute(
                    "data-auma-playlist"
                  );
    ...
    */
            var currentTimeSelectors =
              document.querySelectorAll(".auma-current-time");
    ...
    */
            ...
            for (var i = 0; i < currentTimeSelectors.length; i++) {
              var playlist =
                currentTimeSelectors[i].getAttribute("data-auma-playlist");
    ...
    */
            var currentTimeSelectors = document.querySelectorAll(
              '.auma-current-time[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
    ...
    */
      ...
      */
              var currentTimeSelectors = document.querySelectorAll(
                '.auma-current-time[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
        ...
        var DurationCountDownTimeElements = (function () {
          ...
          function syncGlobal(timeRemaining) {
            ...
            for (var i = 0; i < durationTimeRemainingSelectors.length; i++) {
              var playlist =
                durationTimeRemainingSelectors[i].getAttribute(
                  "data-auma-playlist"
                );
          ...
          function syncPlaylist(timeRemaining) {
            var durationTimeRemainingSelectors = document.querySelectorAll(
              '.auma-time-remaining[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
          ...
          function syncSong(timeRemaining) {
            if (_config2.default.active_playlist == null) {
              var durationTimeRemainingSelectors = document.querySelectorAll(
                '.auma-time-remaining[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
      ...
      */
        ...
        var DurationHourElements = (function () {
          ...
          function syncGlobal(hours) {
            ...
            for (var i = 0; i < durationHourSelectors.length; i++) {
              var playlist =
                durationHourSelectors[i].getAttribute("data-auma-playlist");
          ...
          function syncPlaylist(hours) {
            var durationHourSelectors = document.querySelectorAll(
              '.auma-duration-hours[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
          ...
          function syncSong(hours) {
            if (_config2.default.active_playlist == null) {
              var durationHourSelectors = document.querySelectorAll(
                '.auma-duration-hours[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
        ...
        var DurationMinuteElements = (function () {
          ...
          function syncGlobal(minutes) {
            var durationMinuteSelectors = document.querySelectorAll(
              ".auma-duration-minutes"
            );

            for (var i = 0; i < durationMinuteSelectors.length; i++) {
              var playlist =
                durationMinuteSelectors[i].getAttribute("data-auma-playlist");
          ...
          function syncPlaylist(minutes) {
            var durationMinuteSelectors = document.querySelectorAll(
              '.auma-duration-minutes[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
          ...
          function syncSong(minutes) {
            if (_config2.default.active_playlist == null) {
              var durationMinuteSelectors = document.querySelectorAll(
                '.auma-duration-minutes[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
        ...
        var DurationSecondElements = (function () {
          ...
          function syncGlobal(seconds) {
            var durationSecondSelectors = document.querySelectorAll(
              ".auma-duration-seconds"
            );

            for (var i = 0; i < durationSecondSelectors.length; i++) {
              var playlist =
                durationSecondSelectors[i].getAttribute("data-auma-playlist");
          ...
          function syncPlaylist(seconds) {
            var durationSecondSelectors = document.querySelectorAll(
              '.auma-duration-seconds[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
          ...
          function syncSong(seconds) {
            if (_config2.default.active_playlist == null) {
              var durationSecondSelectors = document.querySelectorAll(
                '.auma-duration-seconds[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
        ...
        var DurationTimeElements = (function () {
          ...
          function syncGlobal(durationText) {
            ...
            for (var i = 0; i < durationTimeSelectors.length; i++) {
              var playlist =
                durationTimeSelectors[i].getAttribute("data-auma-playlist");
          ...
          function syncPlaylist(durationText) {
            var durationTimeSelectors = document.querySelectorAll(
              '.auma-duration-time[data-auma-playlist="' +
                _config2.default.active_playlist +
                '"]'
            );
          ...
          function syncSong(durationText) {
            if (_config2.default.active_playlist == null) {
              var durationTimeSelectors = document.querySelectorAll(
                '.auma-duration-time[data-auma-song-index="' +
                  _config2.default.active_index +
                  '"]'
              );
      ...
      /***/ function (module, exports) {
        module.exports = {
          ...
          version: "5.3.0",
          description:
            "A JavaScript library that allows you to control the design of your media controls in your webpage -- not the browser. No dependencies (jQuery not required) https://521dimensions.com/open-source/aumajs",
          main: "dist/auma.js",
          devDependencies: {
            "babel-core": "^6.26.3",
            "babel-loader": "^7.1.5",
          ...
          funding: {
            type: "opencollective",
            url: "https://opencollective.com/aumajs",
          },
          scripts: {
          ...
          repository: {
            type: "git",
            url: "git+https://github.com/521dimensions/aumajs.git",
          },
          keywords: ["webaudio", "html5", "javascript", "audio-player"],
          author: "521 Dimensions (https://521dimensions.com)",
          license: "MIT",
          bugs: { url: "https://github.com/521dimensions/aumajs/issues" },
          homepage: "https://github.com/521dimensions/aumajs#readme",
        };
